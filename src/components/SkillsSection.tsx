      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
          ...
          <p className="max-w-[900px] text-foreground/70 md:text-xl/relaxed">
            A snapshot of the technologies, languages, and tools I use to bring
            ideas to life.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {skills.map((skillCategory) => (
            <Card key={skillCategory.category} className="shadow-lg">
              <CardHeader>
                <CardTitle className="font-headline text-2xl bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-600 bg-clip-text text-transparent">
